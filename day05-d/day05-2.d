...
int main() {
  ...
  while (prog[cntr] != 99) {
    ...
    switch (instr % 100) {
      case 1:
        int x = (instr / 100) % 10 == 0 ? prog[prog[cntr+1]] : prog[cntr+1];
        int y = (instr / 1000) % 10 == 0 ? prog[prog[cntr+2]] : prog[cntr+2];
        prog[prog[cntr+3]] = x+y;
        cntr += 4;
        break;
      case 2:
        int x = (instr / 100) % 10 == 0 ? prog[prog[cntr+1]] : prog[cntr+1];
    ...
    writefln("%d", x);
      ...
      case 8:
        ...
        break;
      default:
        writefln("Bad instruction: %d", instr);
        return 1;
    }
  }
  return 0;
